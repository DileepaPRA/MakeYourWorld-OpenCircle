...
export const worldCatalog: WorldCatalogEntry[] = [
  {
    ...
    segmentPlan: [
      ...
      "Whispering Ferns (forest-06)",
      "Sunken Hollow (forest-07)",
      "Pine Crest (forest-08)",
      "Wildflower Clearing (forest-09)",
      "Twilight Lookout (forest-10)",
    ],
  ...
  },
  {
    ...
    segmentPlan: [
      ...
      "Binary Solar Rim (universe-06)",
      "Stardust Expanse (universe-07)",
      "Quasar Horizon (universe-08)",
      "Pulsar Drift (universe-09)",
      "Cosmic Void Edge (universe-10)",
    ],
  ...
  },
  {
    ...
    segmentPlan: [
      ...
      "Sunken Shipwreck Reef (ocean-06)",
      "Thermal Vent Basin (ocean-07)",
      "Kelp Canopy Run (ocean-08)",
      "Bioluminescent Cavern (ocean-09)",
      "Deep Trench Floor (ocean-10)",
    ],
  ...
  },
  {
    ...
    segmentPlan: [
      ...
      "Harbor Promenade (city-06)",
      "Old Brick Warehouse (city-07)",
      "Artisan Alley (city-08)",
      "Civic Plaza (city-09)",
      "Metro Junction (city-10)",
    ],
  ...
  },
  {
    ...
    segmentPlan: [
      ...
      "Old Mill Pond (village-06)",
      "Orchard Lane (village-07)",
      "Timber Bridge (village-08)",
      "Bakers Row (village-09)",
      "Hillside Chapel (village-10)",
    ],
  ...
  },
  {
    ...
    segmentPlan: [
      ...
      "Hidden Sea Cove (island-06)",
      "Coral Atoll (island-07)",
      "Jungle Waterfall (island-08)",
      "Tide Pool Terraces (island-09)",
      "Starfish Sandbar (island-10)",
    ],
  ...
  },
  {
    ...
    segmentPlan: [
      ...
      "Sunflower Meadows (farm-06)",
      "Quiet Duck Pond (farm-07)",
      "Old Stone Silo (farm-08)",
      "Haystack Terrace (farm-09)",
      "Rustic Vineyard (farm-10)",
    ],
  ...
  },
  {
    ...
    segmentPlan: [
      ...
      "Botanical Greenhouse (campus-06)",
      "Clocktower Quad (campus-07)",
      "Founders Archway (campus-08)",
      "Campus Amphitheater (campus-09)",
      "Riverside Path (campus-10)",
    ],
  ...
  },
  {
    ...
    segmentPlan: [
      ...
      "Ancient Elven Bridge (fantasy-06)",
      "Celestial Shrine (fantasy-07)",
      "Mage Tower Terrace (fantasy-08)",
      "Fairy Ring Glade (fantasy-09)",
      "Astral Gateway (fantasy-10)",
    ],
  ...
  },
  {
    ...
    segmentPlan: [
      ...
      "Bioluminescent Marsh (alien-06)",
      "Sulphur Geysers (alien-07)",
      "Crater Outpost (alien-08)",
      "Amethyst Dunes (alien-09)",
      "Prismatic Horizon (alien-10)",
    ],
